...
const galleryImages = [
  {
    ...
    description:
      'Our members showcasing their speaking skills at the annual competition.',
  },
  {
    id: 2,
  ...
  },
  {
    ...
    description:
      'Learning from industry professionals and experienced speakers.',
  },
  {
    id: 4,
    ...
    description:
      'Members practicing together and providing feedback to each other.',
  },
  {
    id: 5,
    ...
    description:
      'Club members participating in the inter-college debate tournament.',
  },
  {
    id: 6,
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto">
            Glimpses from our events, workshops, and competitions showcasing the
